...
public class Exemplares implements Serializable, Comparable<Exemplares>{
    ...
    /**
     * 
     * @return Retorna uma String que diz o estado dos exemplares por ser "DISPONIVEL" e "INDISPONIVEL"
     * Se a quantidade disponivel desse exemplar for maior que 0 retorna "DISPONIVEL" caso contrario retorna "DISPONIVEL"
     */
