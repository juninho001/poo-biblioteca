...
public class BibliotecaDAO {
     ...
     */
    public BibliotecaDAO() throws IOException{
    ...
    /**
     * Esse metodo cria os arquivos na pasta local do programa
     * @param jOptionA - Define se as Janelas Ponps seram mostradas
     * @throws IOException error de arquivos
     */
    public BibliotecaDAO(boolean jOptionA) throws IOException{
        alunos_File = new File("alunos.txt");
        funcionarios_File = new File("funcionarios.txt");
        exemplares_File = new File("exemplares.txt");
     ...
     * Esse metodo salva os arquivos passados por parametro
     */
     ...
     * @return Retorna True se o procedimento for um sucessoe e false se ocorrer algum error
     * @throws IOException
     * @throws ClassNotFoundException 
     */
     ...
     */
    public List<Aluno> getAnulos() throws IOException, ClassNotFoundException{
     ...
     * @return Retorna true se o processo de adicionar o aluno "outro" nos arquivos for um sucesso, caso contrario retorna false
     * @throws IOException error de arquivos
     * @throws ClassNotFoundException error de classe
     */
     ...
     * @return Retorna true se o processo de adicionar o funcionario "outro" nos arquivos for um sucesso, caso contrario retorna false
     * @throws IOException error de arquivos
     * @throws ClassNotFoundException error de classe
     */
     ...
     * @return Retorna true se o processo de editar o aluno "outro" nos arquivos for um sucesso, caso contrario retorna false
     * @throws IOException error de arquivos
     ...
     * @return Retorna true se o processo de editar o funcionario "outro" nos arquivos for um sucesso, caso contrario retorna false
     * @throws IOException error de arquivos
     * @throws ClassNotFoundException error de classe
     */
     ...
     * @return Retorna true se o processo de remover o aluno "outro" nos arquivos for um sucesso, caso contrario retorna false
     * @throws IOException error de arquivos 
     * @throws ClassNotFoundException error de classes
     */
     ...
     * @return Retorna true se o processo de remover o funcionario "outro" nos arquivos for um sucesso, caso contrario retorna false
     * @throws IOException error de arquivos
     * @throws ClassNotFoundException error de classes
     */
     ...
     * @return Retorna true se o processo de remover os Exemplares "outro" nos arquivos for um sucesso, caso contrario retorna false
     * @throws IOException error de arquivos
     * @throws ClassNotFoundException error de classes
     */
     ...
     * @return Retorna true se o processo de editar os Exemplares "outro" nos arquivos for um sucesso, caso contrario retorna false
     * @throws IOException error de arquivos    
     * @throws ClassNotFoundException error de classes
     */
