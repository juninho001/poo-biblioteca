...
public class CriarEmprestimoControl {
    ...
    /**
     * Cria um CriarEmprestimoControl que serve para controlar um CriarEmprestimoFrame
    ...
    /**
     * Esse metodo faz uma busca nos arquivos atras de Exemplares que contenham ISBN ou titulo iguais a "palavra"
     * @param palavra palavra a ser procurada
     * @return Retorna uma lista de exemplares que contem alguma caracteristica iguais a "palavra"
     * @throws IOException error de arquivos 
